...
BEGIN_MESSAGE_MAP(CModelEditorApp, CWinAppEx)
...
CModelEditorApp::CModelEditorApp()
{
	...
	SetAppID(_T("ModelEditor.AppID.NoVersion"));
...
// CModelEditorApp customization load/save methods

void CModelEditorApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CModelEditorApp::LoadCustomState()
{
}

void CModelEditorApp::SaveCustomState()
{
}
