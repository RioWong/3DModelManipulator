...
BEGIN_MESSAGE_MAP(CModelEditorDoc, CDocument)
	ON_COMMAND(ID_FILE_OPEN, &CModelEditorDoc::OnFileOpen)
END_MESSAGE_MAP()
...
void CModelEditorDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CModelEditorDoc::InitializeSearchContent()
{
...
void CModelEditorDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
...
void CModelEditorDoc::OnFileOpen()
{
	// TODO: 在此添加命令处理程序代码
}
